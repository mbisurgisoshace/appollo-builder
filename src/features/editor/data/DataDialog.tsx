    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Define a data entity for your project. Data entities can represent
            various types of information that affect your project. You can
            reference data entities in your workflow to manage and utilize
